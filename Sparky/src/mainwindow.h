...
typedef struct LOOP_OBJECT 
{
    ...
    bool isCal;
	bool isEEA;
	bool isInitTempRunStart;
	bool isInitTempRunHigh;
	bool isInitTempRunInject;
	bool isInitInject;
	bool isTempRunOnly;
	QString cut;
	double masterMin;
